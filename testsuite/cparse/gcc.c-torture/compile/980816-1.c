...
/* cp-out: warning: [^:]*: line 37, column 18: identifier "XtVaCreateManagedWidget" not declared */
/* cp-out: warning: [^:]*: line 46, column 2: identifier "XtAddCallback" not declared */
/* cp-out: warning: [^:]*: line 37, column 18 to line 44, column 16: assignment to pointer from integer which is not NULL */
