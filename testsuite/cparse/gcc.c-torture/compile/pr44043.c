...
/* cp-out: warning: [^:]*: line 28, column 12: identifier "nf_hook_thresh" not declared */
/* cp-out: warning: [^:]*: line 74, column 4: identifier "ip_local_error" not declared */
/* cp-out: warning: [^:]*: line 78, column 4: identifier "icmp_out_count" not declared */
