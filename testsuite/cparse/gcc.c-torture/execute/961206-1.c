...
/* cp-out: warning: [^:]*: line 46, column 4: identifier "abort" not declared */
/* cp-out: warning: [^:]*: line 49, column 4: identifier "abort" not declared */
/* cp-out: warning: [^:]*: line 51, column 2: identifier "exit" not declared */
