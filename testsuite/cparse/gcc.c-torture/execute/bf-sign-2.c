...
/* cp-out: warning: [^:]*: line 48, column 1: identifier "abort" not declared */
/* cp-out: warning: [^:]*: line 53, column 1: identifier "abort" not declared */
...
/* cp-out: warning: [^:]*: line 65, column 2: identifier "exit" not declared */
