...
/* cp-out: warning: [^:]*: line 48, columns 1-6: identifier "abort" not declared */
/* cp-out: warning: [^:]*: line 53, columns 1-6: identifier "abort" not declared */
...
/* cp-out: warning: [^:]*: line 65, columns 2-6: identifier "exit" not declared */
