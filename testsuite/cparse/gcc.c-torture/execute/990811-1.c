...
/* cp-out: warning: [^:]*: line 27, column 23: identifier "abort" not declared */
/* cp-out: warning: [^:]*: line 28, column 24: identifier "abort" not declared */
/* cp-out: warning: [^:]*: line 29, column 25: identifier "abort" not declared */
