...
namespace klp
{
  namespace ccp
  {
	...
	void _evaluate_ptr_sub(const types::pointer_type &pt_left,
			       ...
			       ast &a, const target &tgt);
	void _evaluate_shift(const types::integral_type &it_left,
			     const types::integral_type &it_right,
			     ast &a, const target &tgt);
	void _evaluate_bin_binop(const types::integral_type &it_left,
				 const types::integral_type &it_right,
				 ast &a, const target &tgt);
	...
	void _evaluate_cmp(const types::pointer_type &pt_left,
			   const types::integral_type &it_right,
			   ast &a, const target &tgt);
	void _evaluate_cmp(const types::integral_type &it_left,
			   const types::pointer_type &pt_right,
			   ast &a, const target &tgt);
